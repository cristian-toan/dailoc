<?php
     ...
     * @since   0.1
     */
    class CustomMainMenuWalker extends \Walker_Nav_Menu {
        ...
        function start_el(&$output, $item, $depth = 0, $args = [], $id = 0) {
            ...
            if($args->walker->has_children) $classes[] = 'has-child';
            ...
            if($args->walker->has_children) $item_output .= '<i class="fa fa-chevron-down"></i>';
            $item_output .= '</a>';
