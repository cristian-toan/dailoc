		...
		<div class="wrap">
			...
			<div class="tadv-import-export">
				...
				<form action="">
					...
					<p>
						<button type="button" class="button" id="tadv-export-select"><?php _e('Select All', 'tinymce-advanced'); ?></button>
					</p>
				</form>
...
<div class="wrap" id="contain">
	...
	<form id="tadvadmin" method="post" action="">
		...
		<div id="tadvzones">
			...
			<p><label>
					<input type="checkbox" name="options[]" id="menubar" value="menubar" <?php if($this->check_user_setting('menubar')) {
	...
	<?php if($this->check_user_setting('menubar')) {
				echo ' enabled';
			} ?>">
		...
		<div class="advanced-options">
			...
			<div>
				<label><input type="checkbox" name="options[]" value="advlist" id="advlist" <?php if($this->check_user_setting('advlist')) {
						echo ' checked="checked"';
					} ?> />
			...
			<div>
				<label><input type="checkbox" name="options[]" value="contextmenu" id="contextmenu" <?php if($this->check_user_setting('contextmenu')) {
						echo ' checked="checked"';
					} ?> />
			...
			<div>
				<label><input type="checkbox" name="options[]" value="advlink" id="advlink" <?php if($this->check_user_setting('advlink')) {
						echo ' checked="checked"';
					} ?> />
			...
			<div>
				<label><input type="checkbox" name="options[]" value="fontsize_formats" id="fontsize_formats" <?php if($this->check_user_setting('fontsize_formats')) {
						echo ' checked="checked"';
					} ?> />
		...
		<?php
			...
			if(!is_multisite() || current_user_can('manage_sites')) {
				...
				<div class="advanced-options">
					...
					?>
					<div>
						<label><input type="checkbox" name="admin_options[]" value="importcss" id="importcss" <?php if(!$disabled && $this->check_admin_setting('importcss')) {
								echo ' checked="checked"';
							}
								echo $disabled; ?> />
					...
					<div>
						<label><input type="checkbox" name="admin_options[]" value="no_autop" id="no_autop" <?php if($this->check_admin_setting('no_autop')) {
								echo ' checked="checked"';
							} ?> />
					...
					<div>
						<label><input type="checkbox" name="admin_options[]" value="paste_images" id="paste_images" <?php if($this->check_admin_setting('paste_images')) {
								echo ' checked="checked"';
							} ?> />
				...
				<div class="advanced-options">
					...
					<div>
						...
						<p>
							<label><input type="checkbox" name="tadv_enable_at[]" value="edit_post_screen" <?php if($this->check_admin_setting('enable_edit_post_screen')) {
									echo ' checked="checked"';
								} ?> />
								<?php _e('The main editor (Add New and Edit posts and pages)', 'tinymce-advanced'); ?></label>
						</p>
						<p>
							<label><input type="checkbox" name="tadv_enable_at[]" value="rest_of_wpadmin" <?php if($this->check_admin_setting('enable_rest_of_wpadmin')) {
									echo ' checked="checked"';
								} ?> />
								<?php _e('Other editors in wp-admin', 'tinymce-advanced'); ?></label>
						</p>
						<p>
							<label><input type="checkbox" name="tadv_enable_at[]" value="on_front_end" <?php if($this->check_admin_setting('enable_on_front_end')) {
									echo ' checked="checked"';
								} ?> />
